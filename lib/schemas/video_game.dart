...
import 'package:schema_org/schemas/game_server.dart';
import 'package:schema_org/schemas/music_group.dart';
import 'package:schema_org/schemas/game_play_mode.dart';
...
/// interaction with a user interface to generate visual feedback on
/// a video device.
...
class SchemaVideoGame implements SchemaSerializable {
  ...
  /// associated with individual items or with a series, episode,
  /// clip.
  SchemaPerson? actors;
  ...
  /// Directors can be associated with individual items or with a
  /// series, episode, clip.
  ...
  /// Video_game_platforms">video games</a>.  Supported types:
  /// [String], [String], [Thing]
  ...
  /// The composer of the soundtrack.  Supported types: [MusicGroup],
  /// [Person]
  dynamic musicBy;
  ...
  /// An item is an object within the game world that can be collected
  ...
  /// Indicate how many people can play this game (minimum, maximum,
  /// or range).
  SchemaQuantitativeValue? numberOfPlayers;

  /// The task that a player-controlled character, or group of
  ...
  /// Subcategory of the application, e.g 'Arcade Game'.  Supported
  /// types: [String], [String]
  ...
  /// required by other applications).  Supported types: [String],
  /// [String]
  String? featureList;
  ...
  /// Minimum memory requirements.  Supported types: [String],
  /// [String]
  ...
  /// Description of what changed in this version.  Supported types:
  /// [String], [String]
  String? releaseNotes;

  /// DirectX, Java or .NET runtime).  Supported types: [String],
  /// [String]
  String? requirements;

  /// A link to a screenshot image of the app.  Supported types:
  /// [ImageObject], [String]
  dynamic screenshot;
  ...
  /// Storage requirements (free space required).  Supported types:
  /// [String], [String]
