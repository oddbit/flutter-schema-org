...
class SchemaFlight implements SchemaSerializable {
  ...
  /// The estimated time the flight will take.  Supported types:
  /// [Duration], [String]
  ...
  /// The unique identifier for a flight including the airline IATA
  /// code For example, if describing United flight 110, where the
  /// IATA code for United is 'UA', the flightNumber is 'UA110'.
  String? flightNumber;
