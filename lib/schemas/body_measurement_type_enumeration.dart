...
/// Enumerates types (or dimensions) of a person's body
/// measurements, for example for fitting of clothes.
...
enum SchemaBodyMeasurementTypeEnumeration
  ...
  /// Arm length (measured between arms/shoulder line intersection and
  /// the prominent wrist bone) Used, for example, to fit shirts.
  ...
  /// Foot length (measured between end of the most prominent toe and
  /// the most prominent part of the heel) Used, for example, to
  /// measure socks.
  bodyMeasurementFoot('https://schema.org/BodyMeasurementTypeEnumeration'),

  /// Maximum hand girth (measured over the knuckles of the open right
  /// hand excluding thumb, fingers together) Used, for example, to
  /// fit gloves.
  bodyMeasurementHand('https://schema.org/BodyMeasurementTypeEnumeration'),

  /// Maximum girth of head above the ears Used, for example, to fit
  /// hats.
  ...
  /// Girth of hips (measured around the buttocks) Used, for example,
  /// to fit skirts.
  ...
  /// Girth of body just below the bust Used, for example, to fit
  /// women's swimwear.
