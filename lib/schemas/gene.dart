...
/// //en.wikipedia.org/wiki/Gene)) Examples include FOXP2 (Forkhead
...
class SchemaGene {
  ...
  /// digestive system.  Supported types: [AnatomicalStructure],
  /// [AnatomicalSystem], [BioChemEntity], [DefinedTerm]
  dynamic expressedIn;
