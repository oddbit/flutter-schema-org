...
enum SchemaDrugPregnancyCategory implements SchemaMedicalEnumeration {
  ...
  /// fetus in the first trimester of pregnancy (and there is no
  ...
  /// studies have failed to demonstrate a risk to the fetus and there
  /// are no adequate and well-controlled studies in pregnant women.
  fDAcategoryB('https://schema.org/DrugPregnancyCategory'),

  /// A designation by the US FDA signifying that animal reproduction
  /// studies have shown an adverse effect on the fetus and there are
  /// no adequate and well-controlled studies in humans, but potential
  ...
  /// A designation by the US FDA signifying that studies in animals
  /// or humans have demonstrated fetal abnormalities and/or there is
  /// positive evidence of human fetal risk based on adverse reaction
  /// data from investigational or marketing experience, and the risks
