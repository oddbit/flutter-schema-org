...
/// A [[NewsArticle]] and [[CriticReview]] providing a professional
...
class SchemaReviewNewsArticle implements SchemaSerializable {
  ...
  /// conducting both claim reviews and media reviews, in which case
  /// [[relatedMediaReview]] would commonly be used on a
  /// [[ClaimReview]], while [[relatedClaimReview]] would be used on
  /// [[MediaReview]].
  SchemaReview? associatedClaimReview;

  /// An associated [[MediaReview]], related by specific common
  /// content, topic or claim The expectation is that this property
  /// would be most typically used in cases where a single activity is
  /// conducting both claim reviews and media reviews, in which case
  /// [[relatedMediaReview]] would commonly be used on a
  ...
  /// The rating given in this review Note that reviews can themselves
  /// be rated The ```reviewRating``` applies to rating given by the
  /// review The [[aggregateRating]] property applies to the review
