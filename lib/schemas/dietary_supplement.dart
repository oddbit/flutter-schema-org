...
import 'package:schema_org/schemas/recommended_dose_schedule.dart';
...
class SchemaDietarySupplement implements SchemaSerializable {
  ...
  /// breastfeeding, known adverse reactions, and documented efficacy
  /// of the supplement.
  String? safetyConsideration;

  /// Characteristics of the population for which this is intended, or
  /// which typically uses it, e.g 'adults'.
