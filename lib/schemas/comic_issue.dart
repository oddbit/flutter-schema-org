...
/// the combination of the name and volume number of the  	series to
...
class SchemaComicIssue {
  ...
  /// A description of the variant cover  	for the issue, if the issue
  /// is a variant printing For example, "Bryan Hitch  	Variant Cover"
  /// or "2nd Printing Variant".
  String? variantCover;
