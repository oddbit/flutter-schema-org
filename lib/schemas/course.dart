...
import 'package:schema_org/schemas/course_instance.dart';
import 'package:schema_org/schemas/structured_value.dart';
import 'package:schema_org/schemas/syllabus.dart';
...
/// distinct instances which take place at different times or take
/// place at different locations, or be offered through different
/// media or modes of study An educational course is a sequence of
...
class SchemaCourse {
  ...
  /// The identifier for the [[Course]] used by the course
  /// [[provider]] (e.g CS101 or 6.001).
  String? courseCode;

  /// Requirements for taking the Course May be completion of another
  /// [[Course]] or a textual description like "permission of
  /// instructor" Requirements may be a pre-requisite competency,
  /// referenced using [[AlignmentObject]].  Supported types:
  /// [AlignmentObject], [Course], [String]
  ...
  /// An offering of the course at a specific time and place or
  /// through specific media or mode of study or to a specific section
  /// of students.
  ...
  /// Indicates (typically several) Syllabus entities that lay out
  /// what each section of the overall course will cover.
  SchemaSyllabus? syllabusSections;

  /// The total number of students that have enrolled in the history
  /// of the course.
  ...
  /// understand a LearningResource.  Supported types: [DefinedTerm],
  /// [String], [String]
