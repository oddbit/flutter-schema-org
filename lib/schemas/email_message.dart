...
class SchemaEmailMessage implements SchemaSerializable {
  ...
  /// Supported types: [ContactPoint], [Organization], [Person]
  dynamic ccRecipient;

  /// The date/time at which the message has been read by the
  /// recipient if a single recipient exists.  Supported types:
  /// [String], [String]
  String? dateRead;

  /// The date/time the message was received if a single recipient
  /// exists.
  String? dateReceived;
  ...
  /// A sub property of participant The participant who is at the
  /// sending end of the action.  Supported types: [Audience],
  /// [Organization], [Person]
  dynamic sender;

  /// A sub property of recipient The recipient who was directly sent
  /// the message.  Supported types: [Audience], [ContactPoint],
  /// [Organization], [Person]
  dynamic toRecipient;
