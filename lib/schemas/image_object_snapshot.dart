...
/// [[ImageObject]] Two byte-for-byte identical files, for the
/// purposes of this type, considered identical If they have
/// different embedded metadata (e.g XMP, EXIF) the files will
...
class SchemaImageObjectSnapshot implements SchemaSerializable {
  ...
  /// exif data for this object.  Supported types: [PropertyValue],
  /// [String]
  dynamic exifData;
