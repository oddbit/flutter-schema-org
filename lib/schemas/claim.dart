...
/// A [[Claim]] in Schema.org represents a specific,
...
/// includes enough contextual information to minimize the risk of
/// ambiguity or inclarity In practice, many claims are better
/// understood in the context in which they appear or the
/// interpretations provided by claim reviews   Beyond
/// [[ClaimReview]], the Claim type can be associated with related
/// creative works - for example a [[ScholarlyArticle]] or
/// [[Question]] might be [[about]] some [[Claim]]   At this time,
...
class SchemaClaim {
  ...
  /// indicate a claim contained, implied or refined from the content
  /// of a [[MediaObject]].  Supported types: [Organization], [Person]
