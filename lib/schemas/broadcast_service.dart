...
import 'package:schema_org/schemas/broadcast_channel.dart';
...
class SchemaBroadcastService implements SchemaSerializable {
  ...
  /// simple ranges, e.g 87-99 In addition a shortcut idiom is
  /// supported for frequences of AM and FM radio channels, e.g "87
  /// FM".  Supported types: [BroadcastFrequencySpecification],
  /// [String]
  dynamic broadcastFrequency;

  /// //en.wikipedia.org/wiki/ISO_8601) for which the service bases
  /// its broadcasts.
