...
import 'package:schema_org/schemas/hospital.dart';
...
/// An individual medical practitioner For their official address
/// use [[address]], for affiliations to hospitals use
/// [[hospitalAffiliation]]  The [[practicesAt]] property can be
...
class SchemaIndividualPhysician implements SchemaSerializable {
  ...
  /// //en.wikipedia.org/wiki/National_Provider_Identifier">National
  /// Provider Identifier</a> (NPI)   is a unique 10-digit
