...
class SchemaOrganizationRole implements SchemaSerializable {
  /// A number associated with a role in an organization, for example,
  ...
  /// A position played, performed or filled by a person or
  /// organization, as part of an organization For example, an athlete
  /// in a SportsTeam might play in the position named 'Quarterback'.
  /// Supported types: [String], [String]
  String? namedPosition;

  /// A role played, performed or filled by a person or organization
  /// For example, the team of creators for a comic book might fill
  /// the roles named 'inker', 'penciller', and 'letterer'; or an
  /// athlete in a SportsTeam might play in the position named
  /// 'Quarterback'.  Supported types: [String], [String]
  String? roleName;
