...
/// A ProductGroup represents a group of [[Product]]s that vary only
...
/// (including additional types) can be applied to the ProductGroup
/// to represent characteristics shared by each of the (possibly
/// very many) variants Properties that reference a ProductGroup are
...
class SchemaProductGroup {
  ...
  /// [[ProductGroup]] vary, e.g their size, color etc Schema.org
