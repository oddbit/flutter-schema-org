...
class SchemaUnitPriceSpecification implements SchemaSerializable {
  ...
  /// Duration or a Number (in which case the unit of measurement, for
  /// example month, is specified by the unitCode property).
  /// Supported types: [Duration], [QuantitativeValue], [int]
  ...
  /// Specifies after how much time this price (or price component)
  ...
  /// Identifies a price component (for example, a line item on an
  ...
  /// The reference quantity for which a certain price applies, e.g 1
  /// EUR per 4 kWh of electricity This property is a replacement for
  /// unitOfMeasurement for the advanced cases where the price does
  /// not relate to a standard unit.
