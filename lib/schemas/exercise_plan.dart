...
class SchemaExercisePlan implements SchemaSerializable {
  ...
  /// How often one should engage in the activity.  Supported types:
  /// [QuantitativeValue], [String]
  dynamic activityFrequency;

  /// Any additional component of the exercise prescription that may
  /// need to be articulated to the patient This may include the order
  /// of exercises, the number of repetitions of movement,
  ...
  /// exercise, for example, heartbeats per minute May include the
  /// velocity of the movement.  Supported types: [QuantitativeValue],
  /// [String]
  dynamic intensity;

  /// Number of times one should repeat the activity.  Supported
  /// types: [QuantitativeValue], [int]
  dynamic repetitions;

  /// How often one should break from the activity.  Supported types:
  /// [QuantitativeValue], [String]
  dynamic restPeriods;

  /// Quantitative measure of the physiologic output of the exercise;
  /// also referred to as energy expenditure.  Supported types:
  /// [Energy], [QuantitativeValue]
  dynamic workload;
