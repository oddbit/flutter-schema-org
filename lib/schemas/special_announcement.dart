...
import 'package:schema_org/schemas/observation.dart';
import 'package:schema_org/schemas/government_service.dart';
...
/// //en.wikipedia.org/wiki/Atom_(Web_standard)) feed For publishers
/// without such feeds, basic feed-like information can be shared by
/// posting [[SpecialAnnouncement]] updates in a page, e.g using
/// JSON-LD For sites with Atom/RSS functionality, you can point to
/// a feed with the [[webFeed]] property This can be a simple URL,
/// or an inline [[DataFeed]] object, with [[encodingFormat]]
...
class SchemaSpecialAnnouncement {
  ...
  /// larger geographic region like a quarantine of an entire region,
  /// use [[spatialCoverage]].  Supported types: [CivicStructure],
  /// [LocalBusiness]
  ...
  /// Information about disease prevention.  Supported types:
  /// [String], [WebContent]
  dynamic diseasePreventionInfo;

  /// Statistical information about the spread of a disease, either as
  /// [[WebContent]], or  described directly as a [[Dataset]], or the
  /// specific [[Observation]]s in the dataset When a [[WebContent]]
  /// URL is  provided, the page indicated might also contain more
  /// such markup.  Supported types: [Dataset], [Observation],
  /// [String], [WebContent]
  dynamic diseaseSpreadStatistics;

  /// Information about getting tested (for a [[MedicalCondition]]),
  /// e.g in the context of a pandemic.  Supported types: [String],
  /// [WebContent]
  dynamic gettingTestedInfo;

  /// governmentBenefitsInfo provides information about government
  /// benefits associated with a SpecialAnnouncement.
  SchemaGovernmentService? governmentBenefitsInfo;

  /// Indicates a page with news updates and guidelines This could
  /// often be (but is not required to be) the main page containing
  /// [[SpecialAnnouncement]] markup on a site.  Supported types:
  /// [String], [WebContent]
  dynamic newsUpdatesAndGuidelines;

  /// Information about public transport closures.  Supported types:
  /// [String], [WebContent]
  dynamic publicTransportClosuresInfo;

  /// Guidelines about quarantine rules, e.g in the context of a
  /// pandemic.  Supported types: [String], [WebContent]
  dynamic quarantineGuidelines;

  /// Information about school closures.  Supported types: [String],
  /// [WebContent]
  dynamic schoolClosuresInfo;

  /// Information about travel bans, e.g in the context of a pandemic.
  /// Supported types: [String], [WebContent]
  dynamic travelBans;
