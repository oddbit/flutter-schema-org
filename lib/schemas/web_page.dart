...
import 'package:schema_org/schemas/specialty.dart';
...
/// A web page Every web page is implicitly assumed to be declared
/// to be of type WebPage, so the various properties about that
/// webpage, such as <code>breadcrumb</code> may be used We
...
class SchemaWebPage implements SchemaSerializable {
  ...
  /// web page for accuracy and/or completeness.  Supported types:
  /// [Organization], [Person]
  dynamic reviewedBy;
