...
/// //en.wikipedia.org/wiki/Blog), sometimes known as a "weblog"
...
class SchemaBlog implements SchemaSerializable {
  ...
  /// Indicates a post that is part of a [[Blog]] Note that
  /// historically, what we term a "Blog" was once known as a
  /// "weblog", and that what we term a "BlogPosting" is now often
  /// colloquially referred to as a "blog".
