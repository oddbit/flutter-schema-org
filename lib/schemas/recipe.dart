...
import 'package:schema_org/schemas/how_to_section.dart';
import 'package:schema_org/schemas/how_to_step.dart';
import 'package:schema_org/schemas/how_to_supply.dart';
import 'package:schema_org/schemas/how_to_tool.dart';
...
/// A recipe For dietary restrictions covered by the recipe, a few
...
class SchemaRecipe {
  ...
  /// A single ingredient used in the recipe, e.g sugar, flour or
  /// garlic.
  String? ingredients;
  ...
  /// HowToSection items.  Supported types: [CreativeWork],
  /// [ItemList], [String]
  dynamic recipeInstructions;

  /// The quantity produced by the recipe (for example, number of
  /// people served, number of servings, etc).  Supported types:
  ...
  /// or a HowToSection.  Supported types: [CreativeWork],
  /// [HowToSection], [HowToStep], [String]
  dynamic step;
  ...
  /// instructions or a direction.  Supported types: [HowToSupply],
  /// [String]
  dynamic supply;

  /// A sub property of instrument An object used (but not consumed)
  /// when performing instructions or a direction.  Supported types:
  /// [HowToTool], [String]
  dynamic tool;
  ...
  /// The quantity that results by performing instructions For
  /// example, a paper airplane, 10 personalized candles.  Supported
  /// types: [QuantitativeValue], [String]
  dynamic yield;
