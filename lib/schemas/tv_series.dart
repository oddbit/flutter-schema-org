...
class SchemaTVSeries {
  ...
  /// An episode of a TV, radio or game media within a series or
  /// season.
  ...
  /// A season in a media series.  Supported types:
  /// [CreativeWorkSeason], [String]
  dynamic season;
  ...
  /// representing at the most general/abstract level, a work of film
  /// or television  For example, the motion picture known as
  /// "Ghostbusters" has a titleEIDR of
  /// "10.5240/7EC7-228A-510A-053E-CBB8-J" This title (or work) may
  /// have several variants, which EIDR calls "edits" See [[editEIDR]]
  /// Since schema.org types like [[Movie]], [[TVEpisode]],
  /// [[TVSeason]], and [[TVSeries]] can be used for both works and
