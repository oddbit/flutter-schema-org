...
/// [[VideoObject]] Two byte-for-byte identical files, for the
/// purposes of this type, considered identical If they have
/// different embedded metadata the files will differ Different
/// external facts about the files, e.g creator or dateCreated that
...
class SchemaVideoObjectSnapshot {
  ...
  /// Represents textual captioning from a [[MediaObject]], e.g text
  /// of a 'meme'.
