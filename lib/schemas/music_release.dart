...
import 'package:schema_org/schemas/music_release_format_type.dart';
...
class SchemaMusicRelease implements SchemaSerializable {
  ...
  /// The group the release is credited to if different than the
  /// byArtist For example, Red and Blue is credited to "Stefani
  /// Germanotta Band", but by Lady Gaga.  Supported types:
  /// [Organization], [Person]
  dynamic creditedTo;
  ...
  /// MusicRecording.  Supported types: [ItemList], [MusicRecording]
  dynamic track;
