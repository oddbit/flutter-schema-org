...
class SchemaNewsMediaOrganization implements SchemaSerializable {
  ...
  /// For a [[NewsMediaOrganization]], a link to the masthead page or
  /// a page listing top editorial management.  Supported types:
  /// [CreativeWork], [String]
  dynamic masthead;

  /// For a [[NewsMediaOrganization]], a statement on coverage
  /// priorities, including any public agenda or stance on issues.
  /// Supported types: [CreativeWork], [String]
  dynamic missionCoveragePrioritiesPolicy;

  /// For a [[NewsMediaOrganization]] or other news-related
  /// [[Organization]], a statement explaining when authors of
  /// articles are not named in bylines.  Supported types:
  /// [CreativeWork], [String]
  ...
  /// [[NewsMediaOrganization]] or other fact-checking
  /// [[Organization]].  Supported types: [CreativeWork], [String]
