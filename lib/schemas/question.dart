...
class SchemaQuestion implements SchemaSerializable {
  ...
  /// author.  Supported types: [Answer], [ItemList]
  ...
  /// The parent of a question, answer or item in general Typically
  /// used for Q/A discussion threads e.g a chain of comments with the
  /// first comment being an [[Article]] or other [[CreativeWork]] See
  /// also [[comment]] which points from something to a comment about
  /// it.  Supported types: [Comment], [CreativeWork]
  dynamic parentItem;

  /// An answer (possibly one of several, possibly incorrect) to a
  /// Question, e.g on a Question/Answer site.  Supported types:
  /// [Answer], [ItemList]
  ...
  /// The number of upvotes this question, answer or comment has
  /// received from the community.
  int? upvoteCount;
