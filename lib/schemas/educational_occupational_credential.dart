...
class SchemaEducationalOccupationalCredential implements SchemaSerializable {
  ...
  /// Supported types: [DefinedTerm], [String], [String]
  ...
  /// recognition may include a process of quality assurance or
  /// accreditation.
  ...
  /// The geographic area where the item is valid Applies for example
  /// to a [[Permit]], a [[Certification]], or an
