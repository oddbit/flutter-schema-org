...
/// work together to perform a certain task Anatomical systems, such
/// as organ systems, are one organizing principle of anatomy, and
/// can include circulatory, digestive, endocrine, integumentary,
...
class SchemaAnatomicalSystem implements SchemaSerializable {
  ...
  /// Related anatomical structure(s) that are not part of the system
  /// but relate or connect to it, such as vascular bundles associated
