...
import 'package:schema_org/schemas/cdcpmd_record.dart';
...
class SchemaHospital {
  ...
  /// Indicates data describing a hospital, e.g a CDC [[CDCPMDRecord]]
  /// or as some kind of [[Dataset]].  Supported types:
  /// [CDCPMDRecord], [Dataset]
