...
/// An entity holding detailed information about the available bed
/// types, e.g the quantity of twin beds for a hotel room For the
...
class SchemaBedDetails implements SchemaSerializable {
  ...
  /// The type of bed to which the BedDetail refers, i.e the type of
  /// bed available in the quantity indicated by quantity.  Supported
  /// types: [BedType], [String]
  dynamic typeOfBed;
