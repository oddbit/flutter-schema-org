...
class SchemaCoverArt {
  ...
  /// example "20").  Supported types: [String], [int]
  dynamic artEdition;

  /// The material used (E.g Oil, Watercolour, Acrylic, Linoprint,
  /// Marble, Cyanotype, Digital, Lithograph, DryPoint, Intaglio,
  /// Pastel, Woodcut, Pencil, Mixed Media, etc.)  Supported types:
  /// [String], [String]
  String? artMedium;

  /// e.g Painting, Drawing, Sculpture, Print, Photograph, Assemblage,
  /// Collage, etc.  Supported types: [String], [String]
  String? artform;
  ...
  /// The supporting materials for the artwork, e.g Canvas, Paper,
  /// Wood, Board, etc.  Supported types: [String], [String]
